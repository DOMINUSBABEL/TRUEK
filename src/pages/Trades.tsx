    ...
    <div className="p-6 pb-32 bg-neutral min-h-screen">
      ...
      <div className="mb-8 relative">
        ...
        <input
          ...
          className="w-full pl-11 pr-4 py-3.5 bg-surface border border-white/10 rounded-2xl text-white placeholder-gray-500 focus:outline-none transition-all shadow-sm focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
        />
      </div>
