...
export default function Trades() {
  ...
  const fetchTrades = async () => {
    ...
    try {
      ...
      // ⚡ Bolt: Prevent N+1 queries by batching item document fetches
      ...
      // Firestore 'in' queries support a maximum of 30 items per batch
      ...
      const tradesWithDetails = tradesData.map(trade => ({
        ...trade,
        targetItem: trade.targetItemId ? itemsMap[trade.targetItemId] || null : null,
        offeredItem: trade.offeredItemId ? itemsMap[trade.offeredItemId] || null : null
      }));
