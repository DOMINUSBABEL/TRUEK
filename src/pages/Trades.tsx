...
export default function Trades() {
  ...
  const handleAccept = async (trade: any) => {
    try {
      // OPTIMIZATION: Use writeBatch to group multiple document updates into a single network round-trip.
      // This prevents the sequential waterfall of awaits which takes N+3 network requests.
