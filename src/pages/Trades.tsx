...
export default function Trades() {
  ...
  const handleAccept = async (trade: any) => {
    try {
      ...
      // Update challenges (These might need sequential logic as they read before writing in updateChallengeIfActive, so leave as is or refactor if needed. Leaving as is to be safe.)
