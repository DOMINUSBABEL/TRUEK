    ...
    <div className="p-6 pb-32 bg-neutral min-h-screen">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-5">
          ...
          <div className="flex items-center justify-between p-5 bg-tertiary/10 rounded-[2rem] border border-tertiary/20">
            <div>
              ...
              <p id="auction-description" className="text-[10px] font-bold tracking-widest uppercase text-tertiary/70 mt-1">Receive multiple offers</p>
            </div>
            <label htmlFor="auction-toggle" className="relative inline-flex items-center cursor-pointer">
              <input 
                id="auction-toggle"
                type="checkbox" 
              ...
              />
              <div className="w-11 h-6 bg-surface border border-white/10 peer-focus:outline-none peer-focus-visible:ring-2 peer-focus-visible:ring-tertiary peer-focus-visible:ring-offset-2 peer-focus-visible:ring-offset-neutral rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-tertiary"></div>
            </label>
          </div>
        </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-primary text-white text-xs font-bold tracking-widest uppercase py-4 rounded-full shadow-[0_0_20px_rgba(124,77,255,0.3)] hover:bg-primary-hover transition-colors flex justify-center items-center mt-8 disabled:opacity-70 disabled:cursor-not-allowed"
        >
