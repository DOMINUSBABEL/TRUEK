      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-5">
          ...
          <div className="flex items-center justify-between p-5 bg-tertiary/10 rounded-[2rem] border border-tertiary/20">
            <div>
              <label htmlFor="isAuction" className="font-heading font-bold text-tertiary block cursor-pointer">Barter Auction</label>
              <p id="isAuction-desc" className="text-[10px] font-bold tracking-widest uppercase text-tertiary/70 mt-1">Receive multiple offers</p>
            </div>
            <label htmlFor="isAuction" className="relative inline-flex items-center cursor-pointer">
              <input 
                ...
                aria-describedby="isAuction-desc"
              />
              <div className="w-11 h-6 bg-surface border border-white/10 peer-focus:outline-none peer-focus-visible:ring-2 peer-focus-visible:ring-primary rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-tertiary"></div>
            </label>
          </div>
        </div>
