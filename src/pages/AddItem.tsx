    ...
    <div className="p-6 pb-32 bg-neutral min-h-screen">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-5">
          <div>
            <label htmlFor="title" className="block text-[10px] font-bold tracking-widest uppercase text-gray-400 mb-2 cursor-pointer w-fit">
              What are you offering?<span aria-hidden="true" className="text-red-500 ml-1">*</span>
            </label>
            <input
              id="title"
              type="text"
          ...
          <div>
            <label htmlFor="description" className="block text-[10px] font-bold tracking-widest uppercase text-gray-400 mb-2 cursor-pointer w-fit">
              Description<span aria-hidden="true" className="text-red-500 ml-1">*</span>
            </label>
            <textarea
              id="description"
              required
