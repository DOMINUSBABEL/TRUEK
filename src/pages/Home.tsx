        ...
        <div className="space-y-4">
          <div className="relative">
            ...
            <input 
              ...
              className="w-full pl-12 pr-4 py-3.5 bg-surface border border-white/5 focus:bg-surface-light focus:border-primary/50 rounded-full transition-all outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none text-sm text-white placeholder-gray-500"
              value={searchTerm}
          ...
          <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
            <select 
              ...
              className="bg-surface text-gray-300 text-xs font-bold tracking-widest uppercase px-4 py-2.5 rounded-full border border-white/5 outline-none focus:border-primary/50 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none cursor-pointer appearance-none"
