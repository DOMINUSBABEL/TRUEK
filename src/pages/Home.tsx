        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
            <select 
              ...
              className="bg-surface text-gray-300 text-xs font-bold tracking-widest uppercase px-4 py-2.5 rounded-full border border-white/5 outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none focus:border-primary/50 appearance-none"
