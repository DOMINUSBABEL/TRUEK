        ...
        <div className="space-y-4">
          <div className="relative">
            ...
            <input 
              ...
              className="w-full pl-12 pr-10 py-3.5 bg-surface border border-white/5 focus:bg-surface-light focus:border-primary/50 rounded-full transition-all outline-none text-sm text-white placeholder-gray-500 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
              value={searchTerm}
            ...
            {searchTerm && (
              <button
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-white transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded-full p-0.5"
              >
