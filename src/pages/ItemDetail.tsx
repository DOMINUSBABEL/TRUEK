      ...
      try {
        ...
        if (itemDoc.exists()) {
          ...
          if (itemData.isAuction && user?.uid === itemData.ownerId) {
            ...
            // What: Replaced sequential O(N) getDoc queries within a map function with batched O(1) in-queries.
            // Why: Prevent N+1 network waterfall fetching auction offers and users, leading to latency.
            // Impact: Reduces DB round-trips from 2N+1 to O(1) for auction detail resolution.
