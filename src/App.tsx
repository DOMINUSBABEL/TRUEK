...
// Lazy loading page components reduces the initial bundle size
      ...
      <HashRouter>
        <Routes>
          ...
          <Route path="/chat/:id" element={
            <Suspense fallback={<div className="flex justify-center p-8"><div className="animate-pulse text-gray-500">Cargando...</div></div>}>
              <ChatRoom />
            </Suspense>
          } />
        </Routes>
